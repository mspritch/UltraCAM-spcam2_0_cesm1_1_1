...
set run_time       = 26:00:00
set queue          = regular
set priority       = normal 
set account        = m2840
set run_start_date = "2009-01-01"
set start_tod      = "00000"
#set start_tod      = "43200"
set Np             = 1656
set Np_else        = 414
...
setenv CASE        AeroPD_nudgEns31_4x5_m2005_32x1CRM250m_20090101_0Z_$Np
...
./xmlchange  -file env_run.xml -id  RESUBMIT      -val '01'
./xmlchange  -file env_run.xml -id  STOP_N        -val '21'
...
ncdata = '/global/project/projectdirs/m3306/terai/IC_files/L125_4x5/regrid_EI_4x5_L125.cam2.i.2009-01-01-00000.nc'

Nudge_Model = .true.
Nudge_Path = '/global/project/projectdirs/m3306/terai/IC_files/L125_4x5/'
Nudge_File_Template = 'regrid_EI_4x5_L125.cam2.i.%y-%m-%d-%s.nc'
Nudge_Times_Per_Day = 4
Model_Times_Per_Day = 288
Nudge_Uprof = 1
Nudge_Ucoef = 1.
Nudge_Vprof = 1
Nudge_Vcoef = 1.
...
fincl5 = 'SPWW:A','SPQI:A','SPQS:A','SPQG:A','SPTKE:A','SPBUOYA:A','SPDT:A','SPDQ:A','SPQPEVP:A'
...
cd $CASEROOT
./cesm_setup
#./xmlchange -file env_build.xml -id EXEROOT -val /global/cscratch1/sd/terai/UP/AeroPD_nudgEns31_4x5_m2005_32x1CRM250m_20080801_0Z_1656/bld
./xmlchange -file env_build.xml -id EXEROOT -val /global/cscratch1/sd/terai/UP/AeroPD_nudgEns31_4x5_m2005_32x1CRM250m_20090701_0Z_1656/bld
