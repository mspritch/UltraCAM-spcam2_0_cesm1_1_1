...
set run_time       = 38:00:00
set queue          = skx-normal
set priority       = normal 
set account        = TG-ATM170029
set run_start_date = "2008-11-01"
set start_tod      = "00000"
#set start_tod      = "43200"
set Np             = 828
set Np_else        = 207
...
setenv CASE        AeroPI_nudgEns41plus_4x5_m2005_32x1CRM250m_20081101_0Z_$Np
#setenv CASESET     F_AMIP_CAM5
#setenv CASESET     F_AMIP_SPCAM_sam1mom_shortcrm 
#setenv CASESET     F_2000_UPCAM_m2005_ECPP_PIaero_nx128
setenv CASESET     F_2000_UPCAM_m2005_ECPP_PIaero_dt1p5
#setenv CASESET     F_2000_SPCAM_sam1mom
#setenv CASERES     f09_g16
#setenv CASERES     f19_g16
setenv CASERES     f45_f45
setenv PROJECT     TG-ATM170029
...
./xmlchange  -file env_run.xml -id  STOP_N        -val '28'
...
ncdata = '/work/06166/tg854660/stampede2/UP_init_files/L125_4x5/regrid_EI_4x5_L125.cam2.i.2008-11-01-00000.nc'

Nudge_Model = .true.
Nudge_Path = '/work/06166/tg854660/stampede2/UP_init_files/L125_4x5/'
...
fincl6 = 'A_AUT:A','A_ACC:A','A_EVPC:A','A_EVPR:A','SPQPFALL:A','SPQPSRC:A','CLDLIQAP:I'
...
if ( $t_or_f == "TRUE" ) then
    ...
    echo "Build completed and compile is good - not submitted" 
else
