...
# Relative to Cori hp3 scaling runs the only difference is atm_ncpl = 48 now not 288
# (i.e. dtime = 1800 not 300)
...
setenv CASE        scalability_eds_hp4_4xacc_${thescale}_4x5_L125C32_250m_1mom
...
fincl2 = 'TGCLDLWP:A','TGCLDIWP:A','PS:A','FLUT:A','FSNTOA:A','FLNS:A','FSNS:A','FLNT:A','FSDS:A','FSNT:A','FSUTOA:A','SOLIN:A','LWCF:A','SWCF:A','CLDTOT:A','CLDHGH:A',
         ...
         'FLUTC:A','OMEGA500:A'
fincl3 = 'T:A','Q:A','Z3:A','CLOUD:A','CLDICE:A','CLDLIQ:A','CLDTOT:A','OMEGA:A','U:A','V:A','QRL:A','QRS:A','TIMINGF:A','SPQC:A','SPQI:A','SPQS:A','SPQG:A','SPQR:A',
         ...
         'OMEGA500:A','PS:A','SPMC:A','SPMCUP:A','SPMCDN:A','SPMCUUP:A','SPMCUDN:A','SPWW:A','SPBUOYA:A','SPQTFLX:A','SPTKE:A','SPTKES:A','SPTK:A','SPQTFLXS:A','SPQPFLX:A',
         'SPPFLX:A','SPQTLS:A','SPQTTR:A','SPQPTR:A','SPQPEVP:A','SPQPFALL:A','SPQPSRC:A','SPTLS:A','PS:A','QAP:I','TAP:I','QBP:I','TBP:I','CLDLIQAP:I','CLDLIQBP:I','DTCORE:A',
         'PTTEND:A','PTEQ:A','SPDT:A','SPDQ:A','DTV:A','VD01:A','SHFLX:A','LHFLX:A','QRL:A','QRS:A','T:A','U:A','V:A','OMEGA:A','Q:A','VT:A','VU:A','VV:A','VQ:A','UU:A','OMEGAT:A'
nhtfrq = 0,-3,-24
mfilt  = 1,8,1
/
EOF
