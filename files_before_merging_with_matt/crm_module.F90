...
! hm 8/31/11 new output for gcm-grid and time-step avg process rates
                       ...
                       crm_qc, crm_ww, crm_qi, crm_qs, crm_qg, crm_qr, &
#ifdef m2005
...
#endif
                       utendout, vtendout)   !hparish added utendout and vtendout for outputting.
...
!       Large-scale and surface forcing:
     ...
     call crm_forcing()
!     call crm_scaled_forcing()  !hparish suspects if qtend values are too small.
...
! CRM horizontal mean evolution artificially.
         call accelerate_crm(crm_accel_factor)
      endif
#endif
