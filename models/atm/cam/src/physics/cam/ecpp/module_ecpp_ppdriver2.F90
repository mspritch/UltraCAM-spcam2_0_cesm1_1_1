...
! Quiescent class
           call addfld(trim(cnst_name(ichem))//'SFACHQU_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from aqueus chemistry in ECPP (quiescent)' , phys_decomp)
           call addfld(trim(cnst_name(ichem))//'SFREMQU_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from renaming in ECPP (quiescent)' , phys_decomp)
           call addfld(trim(cnst_name(ichem))//'SFACTQU_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from activation/resuspension ECPP (quiescent)' , phys_decomp)
           call addfld(trim(cnst_name(ichem))//'SFWETQU_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from wet removable in ECPP (quiescent)' , phys_decomp)
           call addfld(trim(cnst_name(ichem))//'SFRESQU_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from resupspension in wet removable in ECPP (quiescent)' , phys_decomp)
           call addfld(trim(cnst_name(ichem))//'SFCONQU_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from convective transport in ECPP (quiescent)' , phys_decomp)

! Updraft class
           call addfld(trim(cnst_name(ichem))//'SFACHUP_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from aqueus chemistry in ECPP (updraft)' , phys_decomp)
           call addfld(trim(cnst_name(ichem))//'SFREMUP_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from renaming in ECPP (updraft)' , phys_decomp)
           call addfld(trim(cnst_name(ichem))//'SFACTUP_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from activation/resuspension ECPP (updraft)' , phys_decomp)
           call addfld(trim(cnst_name(ichem))//'SFWETUP_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from wet removable in ECPP (updraft)' , phys_decomp)
           call addfld(trim(cnst_name(ichem))//'SFRESUP_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from resupspension in wet removable in ECPP (updraft)' , phys_decomp)
           call addfld(trim(cnst_name(ichem))//'SFCONUP_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from convective transport in ECPP (updraft)' , phys_decomp)

! Downdraft class
           call addfld(trim(cnst_name(ichem))//'SFACHDN_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from aqueus chemistry in ECPP (downdraft)' , phys_decomp)
           call addfld(trim(cnst_name(ichem))//'SFREMDN_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from renaming in ECPP (downdraft)' , phys_decomp)
           call addfld(trim(cnst_name(ichem))//'SFACTDN_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from activation/resuspension ECPP (downdraft)' , phys_decomp)
           call addfld(trim(cnst_name(ichem))//'SFWETDN_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from wet removable in ECPP (downdraft)' , phys_decomp)
           call addfld(trim(cnst_name(ichem))//'SFRESDN_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from resupspension in wet removable in ECPP (downdraft)' , phys_decomp)           
           call addfld(trim(cnst_name(ichem))//'SFCONDN_EP', 'kg/m2/s', 1, 'A', trim(cnst_name(ichem))//' column-integrated tendency from convective transport in ECPP (downdraft)' , phys_decomp)

        end do
        do ichem=param_first_ecpp, pcnst
           if(.not. (cnst_name_cw(ichem) == ' ')) then
             call addfld(trim(cnst_name_cw(ichem))//'EP', 'kg/kg/s', pver, 'A', trim(cnst_name_cw(ichem))//' tendency from ECPP' , phys_decomp)
             call addfld(trim(cnst_name_cw(ichem))//'ACHEM_EP', 'kg/kg/s', pver, 'A', trim(cnst_name_cw(ichem))//' tendency from aqueous chemistry in ECPP' , phys_decomp )
             call addfld(trim(cnst_name_cw(ichem))//'RENM_EP', 'kg/kg/s', pver, 'A', trim(cnst_name_cw(ichem))//' tendency from renaming in ECPP' , phys_decomp )
             call addfld(trim(cnst_name_cw(ichem))//'ACT_EP', 'kg/kg/s', pver, 'A', trim(cnst_name_cw(ichem))//' tendency from activation/resuspension in ECPP' , phys_decomp)
             call addfld(trim(cnst_name_cw(ichem))//'WET_EP', 'kg/kg/s', pver, 'A', trim(cnst_name_cw(ichem))//' tendency from wet removable in ECPP' , phys_decomp)
             call addfld(trim(cnst_name_cw(ichem))//'WRESU_EP', 'kg/kg/s', pver, 'A', trim(cnst_name_cw(ichem))//' tendency from resuspension in wet removable in ECPP' , phys_decomp)
             call addfld(trim(cnst_name_cw(ichem))//'CONV_EP', 'kg/kg/s', pver, 'A', trim(cnst_name_cw(ichem))//' tendency from convective tansport in ECPP' , phys_decomp)

             call addfld(trim(cnst_name_cw(ichem))//'SFEP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from ECPP' , phys_decomp)
             call addfld(trim(cnst_name_cw(ichem))//'SFACHEM_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from aqueus chemistry in ECPP' , phys_decomp)
             call addfld(trim(cnst_name_cw(ichem))//'SFRENM_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from renaming chemistry in ECPP' , phys_decomp)
             call addfld(trim(cnst_name_cw(ichem))//'SFACT_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from activation/resuspension ECPP' , phys_decomp) 
             call addfld(trim(cnst_name_cw(ichem))//'SFWET_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from wet removable in ECPP' , phys_decomp)
             call addfld(trim(cnst_name_cw(ichem))//'SFWRESU_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from resuspension in wet removable in ECPP' , phys_decomp)
             call addfld(trim(cnst_name_cw(ichem))//'SFCONV_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from convective transport in ECPP' , phys_decomp)

! Quiescent class
           call addfld(trim(cnst_name_cw(ichem))//'SFACHQU_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from aqueus chemistry in ECPP (quiescent)' , phys_decomp)
           call addfld(trim(cnst_name_cw(ichem))//'SFREMQU_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from renaming in ECPP (quiescent)' , phys_decomp)
           call addfld(trim(cnst_name_cw(ichem))//'SFACTQU_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from activation/resuspension ECPP (quiescent)' , phys_decomp)
           call addfld(trim(cnst_name_cw(ichem))//'SFWETQU_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from wet removable in ECPP (quiescent)' , phys_decomp)
           call addfld(trim(cnst_name_cw(ichem))//'SFRESQU_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from resupspension in wet removable in ECPP (quiescent)' , phys_decomp)
           call addfld(trim(cnst_name_cw(ichem))//'SFCONQU_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from convective transport in ECPP (quiescent)' , phys_decomp)

! Updraft class
           call addfld(trim(cnst_name_cw(ichem))//'SFACHUP_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from aqueus chemistry in ECPP (updraft)' , phys_decomp)
           call addfld(trim(cnst_name_cw(ichem))//'SFREMUP_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from renaming in ECPP (updraft)' , phys_decomp)
           call addfld(trim(cnst_name_cw(ichem))//'SFACTUP_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from activation/resuspension ECPP (updraft)' , phys_decomp)
           call addfld(trim(cnst_name_cw(ichem))//'SFWETUP_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from wet removable in ECPP (updraft)' , phys_decomp)
           call addfld(trim(cnst_name_cw(ichem))//'SFRESUP_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from resupspension in wet removable in ECPP (updraft)' , phys_decomp)
           call addfld(trim(cnst_name_cw(ichem))//'SFCONUP_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from convective transport in ECPP (updraft)' , phys_decomp)

! Downdraft class
           call addfld(trim(cnst_name_cw(ichem))//'SFACHDN_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from aqueus chemistry in ECPP (downdraft)' , phys_decomp)
           call addfld(trim(cnst_name_cw(ichem))//'SFREMDN_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from renaming in ECPP (downdraft)' , phys_decomp)
           call addfld(trim(cnst_name_cw(ichem))//'SFACTDN_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from activation/resuspension ECPP (downdraft)' , phys_decomp)
           call addfld(trim(cnst_name_cw(ichem))//'SFWETDN_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from wet removable in ECPP (downdraft)' , phys_decomp)
           call addfld(trim(cnst_name_cw(ichem))//'SFRESDN_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from resupspension in wet removable in ECPP (downdraft)' , phys_decomp)
           call addfld(trim(cnst_name_cw(ichem))//'SFCONDN_EP', 'kg/m2/s', 1, 'A', trim(cnst_name_cw(ichem))//' column-integrated tendency from convective transport in ECPP (downdraft)' , phys_decomp)

           end if
        end do

        call addfld('AQSO4_H2O2_EP', 'kg/m2/s', 1, 'A', 'SO4  aqueous phase chemistry due to H2O2 (kg/m2/s) in ECPP' , phys_decomp)
        call addfld('AQSO4_O3_EP', 'kg/m2/s', 1, 'A', 'SO4  aqueous phase chemistry due to O3 (kg/m2/s) in ECPP' , phys_decomp)
        call addfld('XPH_LWC_EP', ' ', pver, 'A', 'pH value multiplied by lwc in ECPP', phys_decomp)
