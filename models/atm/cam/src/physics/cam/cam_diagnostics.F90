...
! Revision history: 
!
! May, 2009: Minghuai Wang: CRM output variables are added in diag_init (adopted from 
!   spcam3.5, Marat Khairoutdinov, mkhairoutdin@ms.cc.sunysb.edu)
! 
...
call add_default (bpcnst(1)   , history_budget_histfile_num, ' ')
   ...
   call addfld ('BFLX    ','K m/s   ',1,    'A','CRM large-scale surface buoyancy flux (K m/s)',phys_decomp)
   ...
   call addfld ('NN2L_TBOT' ,'K       ',1,    'I','Lowest model level temperature', phys_decomp)
   call addfld ('NN2L_ZBOT' ,'m       ',1,    'I','Lowest model level height above surface', phys_decomp)
   call addfld ('NN2L_UBOT' ,'m/s     ',1,    'I','Lowest model level u wind', phys_decomp)
   call addfld ('NN2L_VBOT' ,'m/s     ',1,    'I','Lowest model level v wind', phys_decomp)
   call addfld ('NN2L_QBOT' ,'kg/kg   ',1,    'I','Lowest model level specific humidity', phys_decomp)
   call addfld ('NN2L_PBOT' ,'Pa      ',1,    'I','Lowest model level pressure', phys_decomp)
   call addfld ('NN2L_RHO'  ,'kg/m3   ',1,    'I','Lowest model level density', phys_decomp)
   call addfld ('NN2L_NETSW'  ,'W/m2   ',1,    'I','Net shortwave flux at surface', phys_decomp)
   call addfld ('NN2L_FLWDS'  ,'W/m2   ',1,    'I','Down longwave flux at surface',phys_decomp)
   call addfld ('NN2L_PRECSC'  ,'m/s   ',1,    'I','Convective snow rate',phys_decomp)
   call addfld ('NN2L_PRECSL'  ,'m/s   ',1,    'I','Stratiform snow rate',phys_decomp)
   call addfld ('NN2L_PRECC'  ,'m/s   ',1,    'I','Convective precipitation rate',phys_decomp)
   call addfld ('NN2L_PRECL'  ,'m/s   ',1,    'I','Stratiform precip rate',phys_decomp)
   call addfld ('NN2L_SOLL'  ,'W/m2   ',1,    'I','Solar downward near infrared direct  to surface',phys_decomp)
   call addfld ('NN2L_SOLS'  ,'W/m2   ',1,    'I','Direct solar rad on surface (< 0.7)',phys_decomp)
   call addfld ('NN2L_SOLLD'  ,'W/m2   ',1,    'I','Diffuse solar rad on surface (>= 0.7)',phys_decomp)
   call addfld ('NN2L_SOLSD'  ,'W/m2   ',1,    'I','Diffuse solar rad on surface (< 0.7)',phys_decomp)
   call addfld ('NN2L_SRFRAD'  ,'W/m2   ',1,    'I','Net surface radiative flux',phys_decomp)
   call addfld ('NN2L_THBOT'  ,'K   ',1,    'I','atm potential T',phys_decomp)
   call addfld ('NN2L_CO2PROG'  ,'kg/m2/s   ',1,    'I','prognostic co2',phys_decomp)
   call addfld ('NN2L_CO2DIAG'  ,'kg/m2/s   ',1,    'I','diagnostic co2',phys_decomp)
   call addfld ('NN2L_PSL'  ,'Pa   ',1,    'I','sea level pressure',phys_decomp)
   call addfld ('NN2L_BCPHIWET'  ,'kg/m2/s   ',1,    'I','Black Carbon hydrophilic wet deposition',phys_decomp)
   call addfld ('NN2L_BCPHIDRY'  ,'kg/m2/s   ',1,    'I','Black Carbon hydrophilic dry deposition',phys_decomp)
   call addfld ('NN2L_BCPHODRY'  ,'kg/m2/s   ',1,    'I','Black Carbon hydrophobic dry deposition',phys_decomp)
   call addfld ('NN2L_OCPHIWET'  ,'kg/m2/s   ',1,    'I','wet deposition of hydrophilic organic carbon',phys_decomp)
   call addfld ('NN2L_OCPHIDRY'  ,'kg/m2/s   ',1,    'I','Organic Carbon hydrophilic dry deposition',phys_decomp)
   call addfld ('NN2L_OCPHODRY'  ,'kg/m2/s   ',1,    'I','Organic Carbon hydrophobic dry deposition',phys_decomp)
   call addfld ('NN2L_DSTWET1'  ,'kg/m2/s   ',1,    'I','wet deposition of dust (bin1)',phys_decomp)
   call addfld ('NN2L_DSTDRY1'  ,'kg/m2/s   ',1,    'I','dry deposition of dust (bin1)',phys_decomp)
   call addfld ('NN2L_DSTWET2'  ,'kg/m2/s   ',1,    'I','wet deposition of dust (bin2)',phys_decomp)
   call addfld ('NN2L_DSTDRY2'  ,'kg/m2/s   ',1,    'I','dry deposition of dust (bin2)',phys_decomp)
   call addfld ('NN2L_DSTWET3'  ,'kg/m2/s   ',1,    'I','wet deposition of dust (bin3)',phys_decomp)
   call addfld ('NN2L_DSTDRY3'  ,'kg/m2/s   ',1,    'I','dry deposition of dust (bin3)',phys_decomp)
   call addfld ('NN2L_DSTWET4'  ,'kg/m2/s   ',1,    'I','wet deposition of dust (bin4)',phys_decomp)
   call addfld ('NN2L_DSTDRY4'  ,'kg/m2/s   ',1,    'I','dry deposition of dust (bin4)',phys_decomp)
  ...
  if (use_SPCAM) then
      ...
      call addfld ('SPWW    ','m^2/s^2 ',pver, 'A','ww(z) from horizontal CRM vertical velocity variance', phys_decomp)
      call addfld ('SPBUOYA ','m^2/s^3 ',pver, 'A','bouyancy flux profile from CRM',          phys_decomp)
      call addfld ('CRM_UTEND ','m/s^2 ',pver, 'A','u tendency from CRM'                    , phys_decomp)
      call addfld ('CRM_VTEND ','m/s^2 ',pver, 'A','v tendency from CRM'                    , phys_decomp)
      ...
      call addfld ('SPACTSS ','        ',pver, 'A','Incloud saturation ratio from CRM'       ,phys_decomp)
      ...
      call addfld ('SPTKE   ','kg/m/s2 ',pver, 'A','Total TKE in CRM'                        ,phys_decomp)
      call addfld ('SPTKES  ','kg/m/s2 ',pver, 'A','SGS TKE in CRM'                          ,phys_decomp)
      call addfld ('SPTK    ','m2/s    ',pver, 'A','SGS TK in CRM'                           ,phys_decomp)
      ...
      call addfld ('SPQTLS  ','kg/kg/s ',pver, 'A','L.S. Total Water Tendency from CRM'      ,phys_decomp)
      ...
      call addfld ('TIMINGF ','        ',1,    'A','CRM CPU usage efficiency: 1 - ideal'     ,phys_decomp)
      call addfld ('CLOUDTOP','        ',pver, 'A','Cloud Top PDF'                           ,phys_decomp)
! Adding crm dimensions to cam history 
      call register_hist_mdim('crm_nx'       ,crm_nx)
      call register_hist_mdim('crm_ny'       ,crm_ny)
      call register_hist_mdim('crm_nz'       ,crm_nz)
      call register_hist_mdim('pverp'        ,pverp)
      call register_hist_mdim('pver'         ,pver)
#ifdef ECPP
      if (use_ECPP) then
         call register_hist_mdim('NCLASS_CL'    ,NCLASS_CL)
         call register_hist_mdim('ncls_ecpp_in' ,ncls_ecpp_in)
         call register_hist_mdim('NCLASS_PR'    ,NCLASS_PR)
      endif
#endif

      call addfld ('CRM_U   ','m/s     ' ,crm_nx*crm_ny*crm_nz, 'I','CRM x-wind'                          ,phys_decomp, mdimnames=(/'crm_nx','crm_ny', 'crm_nz'/))
      call addfld ('CRM_V   ','m/s     ' ,crm_nx*crm_ny*crm_nz, 'I','CRM y-wind'                          ,phys_decomp, mdimnames=(/'crm_nx','crm_ny', 'crm_nz'/))
      call addfld ('CRM_W   ','m/s     ' ,crm_nx*crm_ny*crm_nz, 'I','CRM z-wind'                          ,phys_decomp, mdimnames=(/'crm_nx','crm_ny', 'crm_nz'/))
      call addfld ('CRM_T   ','K       ' ,crm_nx*crm_ny*crm_nz, 'I','CRM Temperature'                     ,phys_decomp, mdimnames=(/'crm_nx','crm_ny', 'crm_nz'/))
      call addfld ('CRM_QV  ','kg/kg    ',crm_nx*crm_ny*crm_nz, 'I','CRM Water Vapor'                     ,phys_decomp, mdimnames=(/'crm_nx','crm_ny', 'crm_nz'/))
      call addfld ('CRM_QC  ','kg/kg    ',crm_nx*crm_ny*crm_nz, 'I','CRM Cloud Water'                     ,phys_decomp, mdimnames=(/'crm_nx','crm_ny', 'crm_nz'/))
      call addfld ('CRM_QI  ','kg/kg    ',crm_nx*crm_ny*crm_nz, 'I','CRM Cloud Ice'                       ,phys_decomp, mdimnames=(/'crm_nx','crm_ny', 'crm_nz'/))
      call addfld ('CRM_QPC ','kg/kg    ',crm_nx*crm_ny*crm_nz, 'I','CRM Precipitating Water'             ,phys_decomp, mdimnames=(/'crm_nx','crm_ny', 'crm_nz'/))
      call addfld ('CRM_QPI ','kg/kg    ',crm_nx*crm_ny*crm_nz, 'I','CRM Precipitating Ice'               ,phys_decomp, mdimnames=(/'crm_nx','crm_ny', 'crm_nz'/))
      call addfld ('CRM_PREC','m/s     ' ,crm_nx*crm_ny,        'I','CRM Precipitation Rate'              ,phys_decomp, mdimnames=(/'crm_nx','crm_ny'/))
      call addfld ('CRM_QRS ','K/s     ' ,crm_nx*crm_ny*crm_nz, 'I','CRM Shortwave radiative heating rate',phys_decomp, mdimnames=(/'crm_nx','crm_ny', 'crm_nz'/))
      call addfld ('CRM_QRL ','K/s     ' ,crm_nx*crm_ny*crm_nz, 'I','CRM Longwave radiative heating rate' ,phys_decomp, mdimnames=(/'crm_nx','crm_ny', 'crm_nz'/))
      call addfld ('CRM_QRAD','K/s     ' ,crm_nx*crm_ny*crm_nz, 'I','CRM radiative heating rate'          ,phys_decomp, mdimnames=(/'crm_nx','crm_ny', 'crm_nz'/))
...
!
    ...
    call outfld('NN2L_SRFRAD',      cam_out%srfrad,      pcols, lchnk)
