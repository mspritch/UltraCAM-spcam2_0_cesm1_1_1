...
!-----------------------------------------------------------------------
    ...
    use phys_control,       only: phys_getopts      !hparish added in order to be able to have the use_SPCAM logical in this routine.
!------------------------------Arguments--------------------------------
!
! Input arguments
!
...
! hparish: the two lines above are just to bring use_SPCAM in to this routine. 
! hparish is implementing Marat's suggestion on increasing the eff radius in order to solve the high cloud radiative bias in ITCZ. 
    if (use_SPCAM) then
     rliqocean = 14.0_r8
     rliqice   = 14.0_r8
     rliqland  = 8.0_r8
