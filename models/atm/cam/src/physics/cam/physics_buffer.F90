#include "dtypes.h"
!===================================================
! DO NOT EDIT THIS FILE, it was generated using ../../../../../utils/pio/genf90.pl 
...
# 403 "physics_buffer.F90.in"
  ...
  ! TYPE int,double,real 
# 435 "physics_buffer.F90.in"
  subroutine pbuf_add_field_int(name, persistance, dtype, dimsizes, index)
  ...
  ! TYPE int,double,real 
# 435 "physics_buffer.F90.in"
  subroutine pbuf_add_field_double(name, persistance, dtype, dimsizes, index)
    character(len=*), intent(in) :: name, persistance
  ...
  ! TYPE int,double,real 
# 435 "physics_buffer.F90.in"
  subroutine pbuf_add_field_real(name, persistance, dtype, dimsizes, index)
    character(len=*), intent(in) :: name, persistance
...
# 511 "physics_buffer.F90.in"
  ...
  ! TYPE int,double,real 
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_1d_int(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
  ...
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_2d_int(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
    integer(i4), pointer :: field(:,:)
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_3d_int(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
    integer(i4), pointer :: field(:,:,:)
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_4d_int(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
    integer(i4), pointer :: field(:,:,:,:)
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_5d_int(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
    integer(i4), pointer :: field(:,:,:,:,:)
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_6d_int(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
    integer(i4), pointer :: field(:,:,:,:,:,:)
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_1d_double(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
  ...
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_2d_double(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
    real(r8), pointer :: field(:,:)
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_3d_double(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
    real(r8), pointer :: field(:,:,:)
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_4d_double(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
    real(r8), pointer :: field(:,:,:,:)
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_5d_double(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
    real(r8), pointer :: field(:,:,:,:,:)
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_6d_double(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
    real(r8), pointer :: field(:,:,:,:,:,:)
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_1d_real(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
  ...
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_2d_real(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
    real(r4), pointer :: field(:,:)
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_3d_real(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
    real(r4), pointer :: field(:,:,:)
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_4d_real(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
    real(r4), pointer :: field(:,:,:,:)
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_5d_real(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
    real(r4), pointer :: field(:,:,:,:,:)
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 548 "physics_buffer.F90.in"
  subroutine get_pbuf1d_field_by_index_6d_real(pbuf, index, field, start,kount)
    type(physics_buffer_desc), pointer:: pbuf(:)
    integer, intent(in) :: index
    real(r4), pointer :: field(:,:,:,:,:,:)
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! TYPE int,double,real 
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_1d_int(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_2d_int(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_3d_int(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_4d_int(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_5d_int(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_6d_int(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_1d_double(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_2d_double(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_3d_double(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_4d_double(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_5d_double(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_6d_double(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_1d_real(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_2d_real(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_3d_real(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_4d_real(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_5d_real(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 571 "physics_buffer.F90.in"
  subroutine get_pbuf2d_field_by_index_6d_real(pbuf2d, lchnk, index, field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: lchnk
    integer, intent(in) :: index
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! TYPE int,double,real 
  ! DIMS 1,2,3,4,5,6
# 588 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_const_by_index_int(pbuf2d,index,const)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
  ...
  ! DIMS 1,2,3,4,5,6
# 588 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_const_by_index_double(pbuf2d,index,const)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
  ...
  ! DIMS 1,2,3,4,5,6
# 588 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_const_by_index_real(pbuf2d,index,const)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
  ...
  ! TYPE int,double,real 
  ! DIMS 1,2,3,4,5,6
# 603 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_const_by_index_int(pbuf,index,const,start,kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    integer(i4),intent(in) :: const
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 603 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_const_by_index_double(pbuf,index,const,start,kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    real(r8),intent(in) :: const
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 603 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_const_by_index_real(pbuf,index,const,start,kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    real(r4),intent(in) :: const
    integer, intent(in), optional :: start(:),kount(:)
  ...
  ! TYPE int,double,real 
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_1d_int(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_2d_int(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_3d_int(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_4d_int(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_5d_int(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_6d_int(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_1d_double(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_2d_double(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_3d_double(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_4d_double(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_5d_double(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_6d_double(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_1d_real(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_2d_real(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_3d_real(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_4d_real(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_5d_real(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 618 "physics_buffer.F90.in"
  subroutine set_pbuf2d_field_by_index_6d_real(pbuf2d,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf2d(:,:)
    integer, intent(in) :: index
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! TYPE int,double,real 
  ! DIMS 1,2,3,4,5,6
# 652 "physics_buffer.F90.in"
  function get_field_chunk_1d_int(field, c) result(fld) 
# 653 "physics_buffer.F90.in"
...
# 653 "physics_buffer.F90.in"
  ...
  ! TYPE int,double,real 
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_1d_int(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
  ...
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_2d_int(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    integer(i4), intent(in) :: field(:,:)
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_3d_int(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    integer(i4), intent(in) :: field(:,:,:)
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_4d_int(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    integer(i4), intent(in) :: field(:,:,:,:)
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_5d_int(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    integer(i4), intent(in) :: field(:,:,:,:,:)
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_6d_int(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    integer(i4), intent(in) :: field(:,:,:,:,:,:)
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_1d_double(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
  ...
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_2d_double(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    real(r8), intent(in) :: field(:,:)
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_3d_double(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    real(r8), intent(in) :: field(:,:,:)
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_4d_double(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    real(r8), intent(in) :: field(:,:,:,:)
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_5d_double(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    real(r8), intent(in) :: field(:,:,:,:,:)
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_6d_double(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    real(r8), intent(in) :: field(:,:,:,:,:,:)
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_1d_real(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
  ...
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_2d_real(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    real(r4), intent(in) :: field(:,:)
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_3d_real(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    real(r4), intent(in) :: field(:,:,:)
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_4d_real(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    real(r4), intent(in) :: field(:,:,:,:)
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_5d_real(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    real(r4), intent(in) :: field(:,:,:,:,:)
    integer,intent(in),optional :: start(:), kount(:)
  ...
  ! DIMS 1,2,3,4,5,6
# 683 "physics_buffer.F90.in"
  subroutine set_pbuf1d_field_by_index_6d_real(pbuf,index,field, start, kount)
    type(physics_buffer_desc), pointer :: pbuf(:)
    integer, intent(in) :: index
    real(r4), intent(in) :: field(:,:,:,:,:,:)
    integer,intent(in),optional :: start(:), kount(:)
