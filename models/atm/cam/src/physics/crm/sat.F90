...
real correction
correction = 1.
!correction = 1. - 0.622    !hparish added this saturation correction to account for the difference in CAM/SAM calculation of saturation mixing ratio.
esat_crm = esatw_crm(t)
qsatw_crm = 0.622 * esat_crm/max(esat_crm,p-correction*esat_crm)
end
...
qsati_crm=0.622 * esat_crm/max(esat_crm,p-correction*esat_crm)
end
