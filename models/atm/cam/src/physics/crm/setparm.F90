...
use crm_grid, only: doclubb, doclubbnoninter
...
!  Set defaults:
	...
	dodamping 	= .true.       !hparish modified to true.
	doupperbound   	= .false.
	docloud   	= .false.
	doprecip        = .true.       !hparish modified to true.
	dolongwave	= .false.
	doshortwave	= .false.
	doradsimple 	= .false.
	dosgs		= .true.       !hparish modified to true to match SAMUW setting.
	dosmagor	= .true.       !hparish modified to true.
	doscalar	= .false.
	dosubsidence	= .false.
	docoriolis	= .false.
	dosurface	= .true.       !hparish modified to true.
	dolargescale    = .false.
	doradforcing    = .false.
	dosfcforcing    = .false.
	donudging_uv	= .false.
