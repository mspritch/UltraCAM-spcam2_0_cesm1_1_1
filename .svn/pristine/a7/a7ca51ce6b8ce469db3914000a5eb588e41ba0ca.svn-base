...
integer, parameter :: dimy1_u = 1-(2+NADV)*YES3D
integer, parameter :: dimy2_u = nyp2+NADV
integer, parameter :: dimx1_v = -1-NADV
integer, parameter :: dimx2_v = nxp2+NADV
integer, parameter :: dimy1_v = 1-2*YES3D
integer, parameter :: dimy2_v = nyp3
integer, parameter :: dimx1_w = -1-NADV
integer, parameter :: dimx2_w = nxp2+NADV
integer, parameter :: dimy1_w = 1-(2+NADV)*YES3D
integer, parameter :: dimy2_w = nyp2+NADV
integer, parameter :: dimx1_s = -2-NADVS
integer, parameter :: dimx2_s = nxp3+NADVS
integer, parameter :: dimy1_s = 1-(3+NADVS)*YES3D
integer, parameter :: dimy2_s = nyp3+NADVS
...
logical   dodamping, doupperbound, docloud, doprecip, &
          ...
          dosmagor, doscalar, doensemble, doxy!, dowallx, dowally, 
logical   docup!, & docolumn, 
logical   doperpetual, doseasons, doradhomo, dosfchomo, &
...
! both UM5 and MPDATA schemes will acsess these variables via grid.f90.
! hparish added the following 5 lines for advection.
logical:: dowallx  = .false.
logical:: dowally  = .false.
logical:: docolumn = .false.
integer:: nstep_adv  = 0
integer:: icycle_adv = 0
