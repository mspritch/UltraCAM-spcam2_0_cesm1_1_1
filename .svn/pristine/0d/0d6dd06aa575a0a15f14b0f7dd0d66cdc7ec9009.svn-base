...
real(r8) qv      (nx, ny, nzm)                ! water vapor
real(r8) qcl     (nx, ny, nzm)                ! liquid water  (condensate)
real(r8) crm_q_inst (nzm)                     ! hparish: instantaneous total water for debugging.
real(r8) crm_qc_inst (nzm)                    ! hparish: instantaneous liquid water for debugging.
real(r8) crm_t_inst (nzm)                     ! hparish: instantaneous t for debugging.
real(r8) crm_tke_inst (nzm)                   ! hparish: instantaneous tke for debugging.
real(r8) crm_ww_inst (nzm)                    ! hparish: instantaneous ww from crm for debugging. 
real(r8) qpl     (nx, ny, nzm)                ! liquid water  (precipitation)
real(r8) qci     (nx, ny, nzm)                ! ice water  (condensate)
real(r8) qpi     (nx, ny, nzm)                ! ice water  (precipitation)
...
real   t0(nzm), q0(nzm), qv0(nzm), tabs0(nzm), tl0(nzm), &
       ...
       tke0(nzm), t01(nzm), q01(nzm), qp0(nzm), qn0(nzm), q0_rad(nzm)
!----------------------------------------------------------------
...
real(r8)   qtend(nzm) ! Large-scale tendency for total water
real(r8)   ttend(nzm) ! Large-scale tendency for temp.
...
real(r8), allocatable :: dqls(:,:) ! Large-scale tendency for total water
real(r8), allocatable :: dtls(:,:) ! Large-scale tendency for temp.
