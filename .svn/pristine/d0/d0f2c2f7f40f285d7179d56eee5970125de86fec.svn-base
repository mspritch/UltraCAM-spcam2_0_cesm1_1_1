...
!        use params, only: dowallx, dowally
	...
	!	Inverse of rho, adz
! The conditional statement was not properly functional. hparish replaced this conditional logic.
...
!		endif
        ...
        if (masterproc) then
         if ( ( nstep < nstep_adv ).or.( icycle < icycle_adv ) ) then
          write(6, *) 'UM5 ERROR: nstep < nstep_adv OR icycle < icycle_adv'
          write(6, *) '=', nstep,nstep_adv,icycle,icycle_adv
          call task_abort()
         endif
        endif
